...
- Similar modules at CPAN in no particular order
    ...
    [Algorithm::MarkovChain](https://metacpan.org/pod/Algorithm::MarkovChain), [Hailo](https://metacpan.org/pod/Hailo), [String::Markov](https://metacpan.org/pod/String::Markov), [Decision::Markov](https://metacpan.org/pod/Decision::Markov)
...
Aldebaran at [www.PerlMonks.org](https://metacpan.org/pod/www.PerlMonks.org) for testing and providing lots
of useful feedback.
